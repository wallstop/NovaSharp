...
**Related Skills**: [debugging-interpreter](debugging-interpreter.md) (debugging execution), [tunit-test-writing](tunit-test-writing.md) (testing opcodes), [lua-fixture-creation](lua-fixture-creation.md) (creating .lua fixtures)
...
See [debugging-interpreter](debugging-interpreter.md) for detailed debugging techniques.

- Add logging in `Processing_Loop()` to trace execution
- Use `ByteCode.Dump()` to inspect generated bytecode
- Compare generated bytecode with reference Lua using `luac -l`
