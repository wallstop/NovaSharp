...
**When to use**: After a large piece of work or investigation, after its normal
validation, and before reporting it complete.
...
| Reusable problem-solving technique      | Create or update one focused `.llm/skills/*.md` skill                      |
