...
"Enforce naming conventions" step as well as the tracked `docs/audits/naming_audit.log`
artifact.
...
### Generating or verifying `docs/audits/naming_audit.log`
...
CI verifies that `docs/audits/naming_audit.log` matches the current audit results via:

```bash
python3 tools/NamingAudit/naming_audit.py --verify-log docs/audits/naming_audit.log
```
