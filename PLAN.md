...
**Progress**: Lua-CSharp comparison rows were wired on 2026-07-01. Reference `lua` CLI wall-time context was wired on 2026-07-02. Pure-Lua Phase A0 workload coverage was expanded on 2026-07-02. Interop and cached-compile comparison rows were wired on 2026-07-02. Benchmark CI was split into bounded runtime, per-scenario comparison, interop comparison, and aggregate report legs on 2026-07-02. See [progress/session-124-phase-a0-luacsharp-comparison.md](progress/session-124-phase-a0-luacsharp-comparison.md), [progress/session-125-phase-a0-lua-cli-context.md](progress/session-125-phase-a0-lua-cli-context.md), [progress/session-126-phase-a0-expanded-workloads.md](progress/session-126-phase-a0-expanded-workloads.md), [progress/session-127-phase-a0-interop-cached-compile.md](progress/session-127-phase-a0-interop-cached-compile.md), and [progress/session-128-split-benchmark-ci.md](progress/session-128-split-benchmark-ci.md). Full five-engine scoreboard baselines, ratio/allocation gates, and Unity IL2CPP spot-check work remain open.
