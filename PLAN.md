...
- **Next steps (2025-11-28 update):**
  ...
  2. Expand the interpreter TUnit host beyond VM/core by porting the descriptor, module, and CLI regression suites so the legacy NUnit project can be retired without coverage loss.
