...
- Progress snapshot (2025-11-28):
  ...
  - Platform detector coverage: added `Platforms/PlatformAutoDetectorTUnitTests.cs` to mirror the NUnit suite (loader selection, Unity detection overrides, AOT probe overrides/exceptions, cached flag restoration). The latest release run above (2025-11-28 23:45 UTC) executes **621** TUnit tests in ~2.4 s with zero failures.
