...
• Progress
  ...
  - ⚠️ `./coverage.ps1` previously aborted because analyzer warnings (e.g., CA1834, CA1305) were promoted to errors; with compiler warnings now gated, rerun coverage to verify the pipeline and capture the refreshed reports.
