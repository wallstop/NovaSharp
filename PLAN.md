...
- Progress snapshot (2025-11-28):
  ...
  - Platform detector coverage: added `Platforms/PlatformAutoDetectorTUnitTests.cs` to mirror the NUnit suite (loader selection, Unity detection overrides, AOT probe overrides/exceptions, cached flag restoration). The release run `dotnet test --project src/tests/NovaSharp.Interpreter.Tests.TUnit/NovaSharp.Interpreter.Tests.TUnit.csproj -c Release` (2025-11-28 17:52 UTC) now executes **474** TUnit tests in ~1.5 s with zero failures.
