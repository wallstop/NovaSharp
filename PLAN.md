...
- Command: `dotnet run -c Release -- --ci` (mirrors CI behaviour). Produces `NovaSharp_tests.log` for triage.
...
3. **Project Structure Refactor (High Priority)**
