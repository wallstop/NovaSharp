...
- **Purpose:** Run Lua fixture files against reference Lua and NovaSharp with version compatibility filtering.
- **Fixtures location:** `src/tests/NovaSharp.Interpreter.Tests/LuaFixtures/` (source-committed, generated by `tools/LuaCorpusExtractor/lua_corpus_extractor_v2.py`).
- **Usage:**
  ```bash
