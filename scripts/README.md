...
2. Prefer `pwsh` for PowerShell scripts on Windows/Linux/macOS; when PowerShell is unavailable, provide a Bash/Python equivalent and document the fallback in this folder.
