...
1. **Analyzer enforcement**
   ...
   - Add a companion rule for private fields so `_camelCase` stays enforced and Hungarian prefixes (`m_`, `i_`, etc.) can be caught automatically once we add the rule.
1. **Audit automation**
