...
1. Copy the license text (or attribution notice) into `src/tests/NovaSharp.Interpreter.Tests/Fixtures/RealWorld/<corpusName>/LICENSE`.
1. Record the source URL / commit hash and the file path in the table above.
