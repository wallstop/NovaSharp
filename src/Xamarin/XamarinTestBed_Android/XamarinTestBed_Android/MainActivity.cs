...
namespace XamarinTestBed_Android
{
    ...
    public class MainActivity : Activity
    {
        ...
        void DoTests()
        {
            ...
            MoonSharp.Interpreter.Tests.TestRunner tr = new MoonSharp.Interpreter.Tests.TestRunner(
                Log
            );
            tr.Test();
        }
        ...
        void Log(TestResult r)
        {
            ...
            {
                string message =
                    (r.Exception is ScriptRuntimeException)
                        ? ((ScriptRuntimeException)r.Exception).DecoratedMessage
                        : r.Exception.Message;
