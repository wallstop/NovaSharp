...
namespace MoonSharp
{
    class Program
    {
        ...
        {
            Console.WriteLine(
                "usage: moonsharp [-H | --help | -X \"command\" | -W <dumpfile> <destfile> [--internals] [--vb] [--class:<name>] [--namespace:<name>] | <script>]"
            );
            Console.WriteLine();
        ...
        {
            Console.WriteLine(
                "usage: moonsharp [-H | --help | -X \"command\" | -W <dumpfile> <destfile> [--internals] [--vb] | <script>]"
            );
        }
