namespace WallstopStudios.NovaSharp.Interpreter.Utilities.OneOf
{
    ...
    /// <summary>
    /// A value-typed discriminated union that can hold one of four types.
    ...
    /// <typeparam name="T3">The fourth possible type.</typeparam>
    public readonly struct FastOneOf<T0, T1, T2, T3> : IEquatable<FastOneOf<T0, T1, T2, T3>>
    {
        ...
        /// <summary>
        /// Initializes a new instance with a value of type <typeparamref name="T3"/>.
        /// </summary>
        /// <param name="value">The value to store.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public FastOneOf(T3 value)
        {
            _value0 = default;
            _value1 = default;
            _value2 = default;
        ...
        /// <summary>
        /// Gets a value indicating whether this instance contains a value of type <typeparamref name="T3"/>.
        /// </summary>
        public bool IsT3
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Gets the index of the currently active type (0, 1, 2, or 3).
        /// </summary>
        public int Index
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Gets the value as type <typeparamref name="T3"/>.
        /// </summary>
        /// <exception cref="InvalidOperationException">Thrown when the value is not of type <typeparamref name="T3"/>.</exception>
        public T3 AsT3
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
        ...
        /// <summary>
        /// Attempts to get the value as type <typeparamref name="T3"/>.
        /// </summary>
        /// <param name="value">When this method returns, contains the value if successful; otherwise, the default value.</param>
        /// <returns><c>true</c> if the value is of type <typeparamref name="T3"/>; otherwise, <c>false</c>.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <param name="matchT3">Function to invoke if the value is of type <typeparamref name="T3"/>.</param>
        ...
        )
        {
            ...
            if (matchT3 == null)
            {
                throw new ArgumentNullException(nameof(matchT3));
            }
            if (_index == 0)
            {
        ...
        /// <param name="actionT3">Action to invoke if the value is of type <typeparamref name="T3"/>.</param>
        ...
        )
        {
            ...
            if (actionT3 == null)
            {
                throw new ArgumentNullException(nameof(actionT3));
            }
            if (_index == 0)
            {
                actionT0(_value0);
        ...
        /// <summary>
        /// Creates a <see cref="FastOneOf{T0, T1, T2, T3}"/> from a value of type <typeparamref name="T0"/>.
        /// </summary>
...
#pragma warning disable CA1000 // Do not declare static members on generic types - required by CA2225 for implicit operator alternate
        public static FastOneOf<T0, T1, T2, T3> FromT0(T0 value)
#pragma warning restore CA1000
        {
            return new FastOneOf<T0, T1, T2, T3>(value);
        }

        /// <summary>
        /// Creates a <see cref="FastOneOf{T0, T1, T2, T3}"/> from a value of type <typeparamref name="T1"/>.
        /// </summary>
        /// <param name="value">The value to wrap.</param>
        /// <returns>A new instance containing the value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#pragma warning disable CA1000 // Do not declare static members on generic types - required by CA2225 for implicit operator alternate
        public static FastOneOf<T0, T1, T2, T3> FromT1(T1 value)
#pragma warning restore CA1000
        {
            return new FastOneOf<T0, T1, T2, T3>(value);
        }
        ...
        /// <summary>
        /// Creates a <see cref="FastOneOf{T0, T1, T2, T3}"/> from a value of type <typeparamref name="T2"/>.
        /// </summary>
        /// <param name="value">The value to wrap.</param>
        /// <returns>A new instance containing the value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#pragma warning disable CA1000 // Do not declare static members on generic types - required by CA2225 for implicit operator alternate
        public static FastOneOf<T0, T1, T2, T3> FromT2(T2 value)
#pragma warning restore CA1000
        {
            return new FastOneOf<T0, T1, T2, T3>(value);
        }
        ...
        /// <summary>
        /// Creates a <see cref="FastOneOf{T0, T1, T2, T3}"/> from a value of type <typeparamref name="T3"/>.
        /// </summary>
        /// <param name="value">The value to wrap.</param>
        /// <returns>A new instance containing the value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#pragma warning disable CA1000 // Do not declare static members on generic types - required by CA2225 for implicit operator alternate
        public static FastOneOf<T0, T1, T2, T3> FromT3(T3 value)
#pragma warning restore CA1000
        {
            return new FastOneOf<T0, T1, T2, T3>(value);
        }
        ...
        /// <summary>
        /// Implicitly converts a value of type <typeparamref name="T0"/> to a <see cref="FastOneOf{T0, T1, T2, T3}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Implicitly converts a value of type <typeparamref name="T1"/> to a <see cref="FastOneOf{T0, T1, T2, T3}"/>.
        /// </summary>
        /// <param name="value">The value to convert.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Implicitly converts a value of type <typeparamref name="T2"/> to a <see cref="FastOneOf{T0, T1, T2, T3}"/>.
        /// </summary>
        /// <param name="value">The value to convert.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Implicitly converts a value of type <typeparamref name="T3"/> to a <see cref="FastOneOf{T0, T1, T2, T3}"/>.
        /// </summary>
        /// <param name="value">The value to convert.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Determines whether two <see cref="FastOneOf{T0, T1, T2, T3}"/> instances are equal.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="FastOneOf{T0, T1, T2, T3}"/> instances are not equal.
        /// </summary>
        /// <param name="left">The left operand.</param>
        /// <param name="right">The right operand.</param>
        ...
        /// <summary>
        /// Determines whether this instance equals another <see cref="FastOneOf{T0, T1, T2, T3}"/>.
        /// </summary>
        ...
        /// <returns><c>true</c> if <paramref name="obj"/> is a <see cref="FastOneOf{T0, T1, T2, T3}"/> and equals this instance; otherwise, <c>false</c>.</returns>
        public override bool Equals(object obj)
        {
            if (obj is FastOneOf<T0, T1, T2, T3> other)
            {
                return Equals(other);
            }
            return false;
        ...
        public override int GetHashCode()
        {
            ...
            return HashCodeHelper.HashCode(_index, _value3);
        }
