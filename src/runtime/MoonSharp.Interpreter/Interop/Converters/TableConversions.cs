...
namespace MoonSharp.Interpreter.Interop.Converters
{
    internal static class TableConversions
    {
        ...
        /// </summary>
        internal static Table ConvertIDictionaryToTable(
            Script script,
        ...
        internal static bool CanConvertTableToType(Table table, Type t)
        {
            ...
            if (Framework.Do.IsGenericType(t))
            {
                ...
                else if ((generic == typeof(Dictionary<,>)) || (generic == typeof(IDictionary<,>)))
                {
                    return true;
                }
            }
        ...
        )
        {
            ...
            foreach (var kvp in table.Pairs)
            {
                ...
                object val = ScriptToClrConversions.DynValueToObjectOfType(
                    kvp.Value,
                    valueType,
                    null,
                    false
        ...
        )
        {
            ...
            System.Collections.IList array = (System.Collections.IList)
        ...
        )
        {
            ...
            System.Collections.IList lst = (System.Collections.IList)
