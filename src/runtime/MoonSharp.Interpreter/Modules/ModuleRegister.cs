...
namespace MoonSharp.Interpreter
{
    ...
    public static class ModuleRegister
    {
        ...
        public static Table RegisterConstants(this Table table)
        {
            ...
            table.Set(
                "_VERSION",
                DynValue.NewString(string.Format("MoonSharp {0}", Script.VERSION))
            );
        ...
        public static Table RegisterModuleType(this Table gtable, Type t)
        {
            ...
            foreach (MethodInfo mi in Framework.Do.GetMethods(t).Where(__mi => __mi.IsStatic))
            {
                ...
                {
                    MoonSharpModuleMethodAttribute attr = (MoonSharpModuleMethodAttribute)
                        mi.GetCustomAttributes(typeof(MoonSharpModuleMethodAttribute), false)
                            .First();
            ...
            foreach (
                FieldInfo fi in Framework
                    ...
                    .Where(_mi =>
                        _mi.IsStatic
                        && _mi.GetCustomAttributes(typeof(MoonSharpModuleMethodAttribute), false)
                            .ToArray()
                            .Length > 0
                    )
            )
            ...
            foreach (
                FieldInfo fi in Framework
                    ...
                    .Where(_mi =>
                        _mi.IsStatic
                        && _mi.GetCustomAttributes(typeof(MoonSharpModuleConstantAttribute), false)
                            .ToArray()
                            .Length > 0
                    )
            )
            {
                MoonSharpModuleConstantAttribute attr = (MoonSharpModuleConstantAttribute)
        ...
        {
            MoonSharpModuleAttribute attr = (MoonSharpModuleAttribute)(
                Framework.Do.GetCustomAttributes(t, typeof(MoonSharpModuleAttribute), false).First()
            );
