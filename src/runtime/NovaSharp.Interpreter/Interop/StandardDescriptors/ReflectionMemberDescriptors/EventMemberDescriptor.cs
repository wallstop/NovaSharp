...
namespace NovaSharp.Interpreter.Interop
{
    ...
    public class EventMemberDescriptor : IMemberDescriptor
    {
        ...
        public static bool CheckEventIsCompatible(EventInfo ei, bool throwException)
        {
            ...
            if (
                (Framework.Do.GetAddMethod(ei) == null)
                || (Framework.Do.GetRemoveMethod(ei) == null)
            )
            {
                if (throwException)
                {
        ...
        {
            switch (
                Framework.Do.GetMethod(EventInfo.EventHandlerType, "Invoke").GetParameters().Length
            )
            {
                case 0:
