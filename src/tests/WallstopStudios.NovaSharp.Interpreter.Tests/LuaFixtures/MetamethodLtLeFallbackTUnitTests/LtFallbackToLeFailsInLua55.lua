...
-- @expects-error: false
-- @source: src/tests/WallstopStudios.NovaSharp.Interpreter.Tests.TUnit/Spec/MetamethodLtLeFallbackTUnitTests.cs:63
-- @test: MetamethodLtLeFallbackTUnitTests.LtFallbackToLeFailsInLua55
