-- Tests that math.random(m, n) requires integer representation for second argument in Lua 5.3+
...
-- @test: MathModuleTUnitTests.RandomRangeIntegerRepresentation2_53plus
math.random(1, 10.5)
