namespace WallstopStudios.NovaSharp.Interpreter.Tests.TUnit.Units.Interop
{
    ...
    public sealed class InteropTUnitTests
    {
        ...
        public async Task ConverterFromObjectCoversPrimitiveAndNullableCases()
        {
            ...
            LuaValue directNumber = LuaValue.FromObject(script, 42);
            ...
            LuaValue fromNullable = LuaValue.FromObject(script, nullableHasValue);
            ...
            LuaValue fromNull = LuaValue.FromObject(script, nullableNull);
        ...
        public async Task ConverterFromObjectMarshalsDictionariesToLuaTables()
        {
            ...
            LuaValue dyn = LuaValue.FromObject(script, dictionary);
        ...
        )
        {
            ...
            LuaValue result = script.DoString("return sum({ x = 10, y = 32 })");
        ...
        {
            Script script = new(version);
            LuaValue payload = LuaValue.FromObject(
                script,
            ...
            LuaValue mutated = script.DoString("return echo(payload)");
            LuaValue tableAfterCall = LuaValue.FromObject(
                script,
