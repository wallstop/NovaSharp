namespace WallstopStudios.NovaSharp.Interop.Generator
{
    ...
    public sealed class LuaInteropSourceGenerator : IIncrementalGenerator
    {
        ...
        )
        {
            ...
            SortedSet<string> enums = new SortedSet<string>(StringComparer.Ordinal);
        ...
        private static void AddEnumType(ITypeSymbol type, SortedSet<string> enums)
        {
            ...
            enums.Add(type.ToDisplayString(SymbolDisplayFormat.CSharpErrorMessageFormat));
        }
        ...
        private static string CreateManifest(LuaObjectModel model)
        {
            ...
            foreach (string enumName in model.ReferencedEnums)
            {
                builder.Append("|enum:");
        ...
        private sealed class LuaObjectModel
        {
            ...
            /// </summary>
            public string[] ReferencedEnums { get; }
