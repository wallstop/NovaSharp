...
- Generated deterministic companion partial output for valid top-level `[LuaObject]` class and struct inputs:
...
- `./scripts/test/quick.sh --full -c LuaInteropGeneratorTUnitTests` passed: 3 tests, 0 failures.
...
- `./scripts/test/quick.sh` passed: 14,879 tests, 0 failures.
