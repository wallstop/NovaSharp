...
- `./scripts/test/quick.sh --full TableLengthFollowsVersionedConstructorBorders` passed after mutation cases were added: 115 tests, 0 failures.
...
- Targeted class suites passed: `./scripts/test/quick.sh -c TableTUnitTests` (555 tests), `./scripts/test/quick.sh -c TableModuleTUnitTests` (211 tests), and `./scripts/test/quick.sh -c SimpleTUnitTests` (417 tests).
- Full TUnit suite passed: `./scripts/test/quick.sh` (14,725 tests, 0 failures).
